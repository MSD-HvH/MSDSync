import { InputSystem, Window } from "./index.js";
...
export class Drag {
	...
	public readonly CreateDrag = (options: { window: Window; input: InputSystem }) => {
		...
		if (IsInBounds(window.toJSON()) && IsDown(0x01) && !this.is_dragging) {
