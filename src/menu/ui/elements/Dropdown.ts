...
export class ChimeraDropdown<N extends string> extends Dropdown<N> {
	...
	public readonly RenderBox = (): ChimeraDropdown<N> => {
	...
	public readonly RenderElements = (options: { font: number }): ChimeraDropdown<N> => {
	...
	public readonly SetState = <V extends boolean>(value: V): ChimeraDropdown<N> => {
		this.state = value;
