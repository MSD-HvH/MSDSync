...
declare namespace Render {
	...
	function String<
		...
		C extends RGBAColor,
		F extends number
	>(x: X, y: Y, centered: IS_C, text: T, color: C, font: F): void;

	function FilledCircle<X extends number, Y extends number, R extends number, C extends RGBAColor>(
		x: X,
		y: Y,
		radius: R,
		color: C
	...
	function Circle<X extends number, Y extends number, R extends number, C extends RGBAColor>(
		x: X,
		y: Y,
		radius: R,
		color: C
...
declare namespace Trace {
	function RawLine<
		...
		M extends number,
		T extends 0 | 1 | 2
	>(skip_entity: ID, from: F, to: S, mask: M, type: T): number[];
	...
	function Line<ID extends EntityID, F extends Vector3D, S extends Vector3D>(
		skip_entity: ID,
		from: F,
		to: S
	): number[];
...
declare namespace Material {
	...
	function SetProxyKeyValue<M extends string, K extends string, V extends string>(
		material: M,
		key: K,
		value: V
	): void;
