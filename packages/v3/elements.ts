...
const checkbox = new MSDSyncCheckbox({ name: "MSDSync Checkbox", window: new Window({ x: 100, y: elementY }) });
const dropdown = new MSDSyncDropdown({
	name: "MSDSync Dropdown",
	elements: ["Hello", "World"],
	window: new Window({ x: 100, y: elementY + 80, width: 140 }),
});
const multiDropdown = new MSDSyncMultiDropdown({
	name: "MSDSync MultiDropdown",
	elements: ["Hello", "World"],
	window: new Window({ x: 100, y: elementY + 80 * 2, width: 140 }),
});
const slider = new MSDSyncSlider({
	name: "MSDSync Slider",
	min: 0,
	max: 100,
	window: new Window({ x: 100, y: elementY + 80 * 3, width: 140 }),
});
