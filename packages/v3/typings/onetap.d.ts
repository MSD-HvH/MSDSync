...
declare namespace UI {
	 ...
	 * ```
	 */
	function ToggleHotkey<T extends keyof Subtabs, S extends Subtabs[T], N extends string>(
		Tab: T,
		Subtab: S,
		Area: string,
		item: N
	...
	function SetColor<T extends keyof Subtabs, N extends string, C extends Color | number[]>(
		Tab: T,
		Area: string,
		name: N,
		color: C
	 ...
	 * ```
	 */
	function AddMultiDropdown<N extends string, E extends string[]>(
		name: N,
		elements: E
	): ["Misc", "JAVASCRIPT", "Script items", N];
	 ...
	 * ```
	 */
	function AddDropdown<N extends string, E extends string[]>(
		name: N,
		elements: E
	): ["Misc", "JAVASCRIPT", "Script items", N];
	 ...
	 * ```
	 */
	function AddSliderFloat<N extends string, F extends number, S extends number>(
		name: N,
		min: F,
		max: S
	): ["Misc", "JAVASCRIPT", "Script items", N];
	 ...
	 * ```
	 */
	function AddSliderInt<N extends string, F extends number, S extends number>(
		name: N,
		min: F,
		max: S
	): ["Misc", "JAVASCRIPT", "Script items", N];
	 ...
	 */
	function IsHotkeyActive<T extends keyof Subtabs, S extends Subtabs[T], N extends string>(
		Tab: T,
		Subtab: S,
		Area: string,
		name: N
	 ...
	 */
	function GetColor<T extends keyof Subtabs, S extends Subtabs[T], N extends string>(
		Tab: T,
		Subtab: S,
		Area: string,
		name: N
	 ...
	 * @param name name of the text box
	 */
	function GetString<T extends keyof Subtabs, S extends Subtabs[T], N extends string>(
		Tab: T,
		Subtab: S,
		Area: string,
		name: N
	 ...
	 */
	function SetEnabled<T extends keyof Subtabs, S extends Subtabs[T], N extends string>(
		Tab: T,
		Subtab: S,
		Area: string,
		name: N,
	...
	function SetEnabled<T extends keyof Subtabs, N extends string>(
		Tab: T,
		Area: string,
		name: N,
		value: boolean | number
	 ...
	 * @param value value which should be set
	 */
	function SetValue<T extends keyof Subtabs, S extends Subtabs[T], N extends string>(
		Tab: T,
		Subtab: S,
		Area: string,
		name: N,
	 ...
	 * @param name name of the element
	 */
	function GetValue<T extends keyof Subtabs, S extends Subtabs[T], N extends string>(
		Tab: T,
		Subtab: S,
		Area: string,
		name: N
